...
public class DatabaseManagerDev {
    ...
    private static final String CREATE_LABELS_TABLE = "CREATE TABLE IF NOT EXISTS labels ("
            + "id INTEGER PRIMARY KEY AUTOINCREMENT,"
            + "ean TEXT NOT NULL,"
            + "sku TEXT NOT NULL,"
    ...
    private static final String CREATE_TOKENS_TABLE = "CREATE TABLE IF NOT EXISTS tokens ("
            + "id INTEGER PRIMARY KEY AUTOINCREMENT,"
